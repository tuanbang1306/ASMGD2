...
Public Class Class1
    Public Function Loadkhachang() As DataSet
        Dim chuoiketnoi As String = "workstation id=PS02585.mssql.somee.com;packet size=4096;user id=tuanbang1306_SQLLogin_1;pwd=1v119g62jj;data source=PS02585.mssql.somee.com;persist security info=False;initial catalog=PS02585"
